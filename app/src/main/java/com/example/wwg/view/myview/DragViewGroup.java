package com.example.wwg.view.myview;
...
public class DragViewGroup extends FrameLayout {
    private static final int HANDLER_UPDATE_RANGE = 0x01;
    private static final int HANDLER_UPDATE_OPENRANGE = 0x02;
    private static final int HANDLER_UPDATE_CLOSERANGE = 0x03;
    private static final int HANDLER_UPDATE_SLIDE_OPENSPEED = 0x04;
